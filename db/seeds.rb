...
User.delete_all
user = User.create! name: "Fox", email: "foxmulder@xfiles.com", password: "123123", password_confirmation: "123123", terms: "1"
...
Section.delete_all
['Material', 'Entrenadores', 'Fisioterapeutas', 'Nutricionistas', 'Escuelas',
...
if Rails.env.development?
  20.times do
    advert = FactoryGirl.create :advert, user: user, state: State.order("RAND()").first,
      sport: Sport.order("RAND()").first, section: Section.order("RAND()").first
